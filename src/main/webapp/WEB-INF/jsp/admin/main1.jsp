    ...
    <div class="topbar-inner clearfix">
        <div class="topbar-logo-wrap clearfix">
            ...
            <ul class="navbar-list clearfix">
                <li><a class="on sendRequest" href="javascript:void(0)" onclick="to_page('/toIndex')">首页</a></li>
        ...
        <div class="top-info-wrap">
            <ul class="top-info-list clearfix">
                ...
                <li><a href="javascript:if(confirm('确实要退出登录吗?'))location='/login'">退出</a></li>
            </ul>
        </div>
    </div>
</div>
...
<div class="container clearfix">
        ...
        <div class="sidebar-content">
            <ul class="sidebar-list">
                <li>
                    ...
                    <div class="p">
                        <ul class="sub-menu">
                            <li><a href="/ahouselist"><i class="icon-font">&#xe008;</i>房源列表</a></li>
                            <li><a href="/toaddhouse"><i class="icon-font">&#xe008;</i>添加房源</a></li>
                ...
                <li>
                    ...
                    <div class="p">
                        <ul class="sub-menu">
                            ...
                            <li><a href="/checkout/getallcheckout"><i class="icon-font">&#xe037;</i>已退租列表</a>
                            </li>
                ...
                <li>
                    ...
                    <div class="p">
                        <ul class="sub-menu">
                            <li><a href="/findapplylist"><i class="icon-font">&#xe037;</i>看房申请</a></li>
                            <li><a href="/applyout/findallapplyout"><i class="icon-font">&#xe037;</i>退租申请</a>
                            </li>
                ...
                <li>
                    ...
                    <div class="p">
                        <ul class="sub-menu">
                            <li>
                                <a href="/findAllUserList"><i class="icon-font">&#xe017;</i>账户管理</a>
                            </li>
                        </ul>
                    </div>
                </li>
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap" id="inside">
            <jsp:include page="${mainPage == null ? '../admin/index.jsp' : mainPage}"/>
        </div>
    </div>
