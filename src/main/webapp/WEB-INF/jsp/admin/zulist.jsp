...
<div>
    ...
    <form id="houseForm" name="houseForm" action="/zulist/findzulist.action" method=post>
        <div class="result-title">
                    ...
                    <c:forEach items="${zulist}" var="zulist">
                        ...
                        <tr style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
                            ...
                            <td><a class="link-update"
                                   href="/hetong/seehetong?house_id=${zulist.house_id }">查看合同</a>
                                &nbsp;&nbsp;
                                <a class="link-del" href="/hetong/deletehetong.action?house_id=${zulist.house_id }"
