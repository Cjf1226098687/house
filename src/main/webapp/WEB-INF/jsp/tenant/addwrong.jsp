...
<div class="result-content">
    <div class="sidebar-title">
        <form action="/wrong/insertwrong" method="post" id="myform" name="myform" enctype="multipart/form-data">
            <table class="insert-tab" width="100%">
                <tbody>
                <th><i class="require-red">*</i>房屋id：</th>
                <td>
                    <input class="common-text required" value="${zulist.house_id}" id="house_id" name="house_id"
                ...
                <tr>
                    ...
                    <td><input class="common-text" name="name" value="${zulist.userlist.name }" id="name" size="50"
                               type="text" readonly></td>
                </tr>
                <tr>
