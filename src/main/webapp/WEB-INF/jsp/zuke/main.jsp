        ...
        <div class="sidebar-content">
            <ul class="sidebar-list">
                <li>
                    ...
                    <div class="p">
                        <ul class="sub-menu">
                            <li><a href="/houselist"><i class="icon-font">&#xe008;</i>房源列表</a></li>
                ...
                <li>
                    ...
                    <div class="p">
                        <ul class="sub-menu">
                            ...
                            <li><a href="/checkout/getmycheckout"><i class="icon-font">&#xe037;</i>已退租列表</a></li>
                ...
                <li>
                    ...
                    <div class="p">
                        <ul class="sub-menu">
                            <li><a href="/getmyapply"><i class="icon-font">&#xe017;</i>看房申请列表</a></li>
                            <li><a href="/applyout/getmyapplyout"><i class="icon-font">&#xe037;</i>退租申请列表</a>
                            </li>
